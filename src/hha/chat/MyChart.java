...
class NotSetDateException extends Exception{
 ...
 *
 */
class NotSetValueException extends Exception{
 ...
 *
 */
class DateNotMatchValueException extends Exception{
 ...
 *
 */
class SameDateException extends Exception{
